...
public:
	...
	void Setup()
	{
		...
		SetupValue(Vars.Ragebot.BadAutoStop, FALSE, "RAGEBOT", "AUTOSTOP");
		SetupValue(Vars.Ragebot.AutoStopCrouch, FALSE, "RAGEBOT", "AUTOSTOPCROUCH");
		SetupValue(Vars.Ragebot.AutoStopShot, FALSE, "RAGEBOT", "AUTOSTOPSHOT");
		SetupValue(Vars.Ragebot.JitterAmount, FALSE, "RAGEBOT", "JITTERAMOUNT");
		SetupValue(Vars.Ragebot.InfinityDuck, FALSE, "RAGEBOT", "INFINITYDUCK");
		...
		SetupValue(Vars.Ragebot.BaimShots, TRUE, "RAGEBOT", "BAIM_SHOTS");
		SetupValue(Vars.Ragebot.ClanTag, TRUE, "CLANTAG", "CLANTAGE_VALUE");
